...
@Transactional
public class SupMetierImpl implements ISupMetier {
	...
	public Employe addEmployeSup(Long codeEmp, String nomEmp) {
		// TODO Auto-generated method stub
		return dao.addEmployeSup(codeEmp, nomEmp);
	}

	@Override
	public long nombreDeGroupes() {
		// TODO Auto-generated method stub
		return dao.nombreDeGroupes();
	}
	...
	public long getNombreOperaionGroupe(String nomGroupe) {
		// TODO Auto-generated method stub
		return dao.getNombreOperaionGroupe(nomGroupe);
	}

	@Override
	public List<Groupe> consulterGroupes(long codeGroupe, int pos, int nbOp) {
		// TODO Auto-generated method stub
		return dao.consulterGroupes(codeGroupe, pos, nbOp);
	}
	...
	public Compte getCompteBycode(String code) {
		// TODO Auto-generated method stub
		return dao.getCompteBycode(code);
	}
	@Override
